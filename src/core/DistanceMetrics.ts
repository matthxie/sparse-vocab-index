export function calculateDotProduct(a: Uint8Array, b: Uint8Array): number {
  let dot = 0;
...
export function calculateQuantizedCosine(a: Uint8Array, b: Uint8Array): number {
  let dot = 0;
  let magA = 0;
  let magB = 0;
  for (let i = 0; i < a.length; i++) {
...
export function calculateJaccard(a: Uint8Array, b: Uint8Array): number {
  let intersection = 0;
  let union = 0;
  for (let i = 0; i < a.length; i++) {
